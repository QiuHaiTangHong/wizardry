package top.begonia.wizardry.core.effect.impl.curse;
...
public class CurseUndeathMobEffect extends CurseMobEffect {
    public CurseUndeathMobEffect(MobEffectCategory category, int color) {
        super(category, color);
    }

    @Override
    public boolean applyEffectTick(@NonNull ServerLevel serverLevel, @NonNull LivingEntity entity, int amplification) {
