package top.begonia.wizardry.core.data.constant.definition.spell;
...
public record SpellProperties(
    ...
    public static final Codec<SpellProperties> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    StringRepresentable.fromEnum(TierEnum::values)
                            .fieldOf("tier")
                            .orElse(TierEnum.DEFAULT)
                            .forGetter(SpellProperties::tier),
                    StringRepresentable.fromEnum(ElementEnum::values)
                            .fieldOf("element")
                            .orElse(ElementEnum.DEFAULT)
                            .forGetter(SpellProperties::element),
                    StringRepresentable.fromEnum(SpellTypeEnum::values)
                            .fieldOf("type").orElse(SpellTypeEnum.DEFAULT)
                            .forGetter(SpellProperties::type),
                    Codec.INT.fieldOf("cost")
                            .orElse(0)
                            .forGetter(SpellProperties::cost),
                    Codec.INT.fieldOf("charge_up")
                            .orElse(0)
                            .forGetter(SpellProperties::chargeUp),
                    Codec.INT.fieldOf("cooldown")
                            .orElse(0)
                            .forGetter(SpellProperties::cooldown),
                    BaseProperties.CODEC.optionalFieldOf("base_properties", BaseProperties.getDefault())
                            .orElse(new BaseProperties(Map.of()))
                            .forGetter(SpellProperties::baseAttributes),
                    EnableProperties.CODEC.optionalFieldOf("enabled", EnableProperties.DEFAULT)
                            .forGetter(SpellProperties::enabled)
