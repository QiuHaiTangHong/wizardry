...
public final class WizardryEntities {
    ...
    public static void creationDefaultEntityAttribute(@NonNull EntityAttributeCreationEvent event) {
        ...
        event.put(WizardryEntities.EVIL_WIZARD.get(), EvilWizardEntity.createAttributes().build());
        event.put(WizardryEntities.REMNANT.get(), RemnantEntity.createAttributes().build());
        event.put(WizardryEntities.VEX_MINION.get(), VexMinionEntity.createAttributes().build());
    }
