package top.begonia.wizardry.client.model.block;
...
public class RunestoneUnbakedBlockModel extends DelegateUnbakedModel {
    public RunestoneUnbakedBlockModel(UnbakedModel delegate) {
        super(delegate);
    }
    ...
    public UnbakedGeometry geometry() {
        ...
        return new UnbakedGeometry() {
            ...
            public @NonNull QuadCollection bake(@NonNull TextureSlots textureSlots, @NonNull ModelBaker modelBaker, @NonNull ModelState modelState, @NonNull ModelDebugName modelDebugName) {
                return Objects.requireNonNull(RunestoneUnbakedBlockModel.super.geometry()).bake(textureSlots, modelBaker, modelState, modelDebugName);
            }
