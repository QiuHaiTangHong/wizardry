...
public class LightningPulseParticle extends WizardryQuadParticle {
    public LightningPulseParticle(ClientLevel level, @NonNull QuadParticleOptions options, double x, double y, double z) {
