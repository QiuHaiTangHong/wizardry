...
public class GuardianBeamParticle extends WizardryQuadParticle {
    public GuardianBeamParticle(ClientLevel level, @NonNull QuadParticleOptions options, double x, double y, double z) {
